...
const EN: PanelCopy = {
  ...
  tool: {
    ...
    labels: {
      'pageAssets.snapshot': 'Read page',
      'management.tabs.click': 'Click element',
      'management.tabs.type': 'Enter text',
      'management.tabs.press': 'Press key',
      'management.tabs.scroll': 'Scroll page',
      'management.tabs.navigate': 'Open page',
      'management.tabs.open': 'Open new tab',
      'management.tabs.list': 'List open tabs',
      'management.tabs.activate': 'Follow tab',
      'management.tabs.close': 'Close tab',
      'management.tabs.back': 'Go back',
      'management.tabs.forward': 'Go forward',
      'management.tabs.reload': 'Reload page',
      'management.tabs.update': 'Update tab',
  ...
  settings: {
    ...
    cdpEnabledHelp: 'Lets the assistant use Chrome DevTools Protocol on the controlled tab: observation (deep DOM and shadow/frame reading, console and Log, network, performance, PDF, screenshots) and unrestricted debugger methods (Runtime.evaluate, Input click/type, and related CDP calls). Hard denylist still blocks Browser.close / crash and Target.closeTarget. It can expose sensitive page and network data, and attaching pauses your own DevTools on that tab. Leave it off unless you are debugging, and turn it back off afterwards.',
...
const ZH: PanelCopy = {
  ...
  tool: {
    ...
    labels: {
      'pageAssets.snapshot': '读取页面',
      'management.tabs.click': '点击元素',
      'management.tabs.type': '填写内容',
      'management.tabs.press': '按下按键',
      'management.tabs.scroll': '滚动页面',
      'management.tabs.navigate': '打开页面',
      'management.tabs.open': '打开新标签页',
      'management.tabs.list': '列出标签页',
      'management.tabs.activate': '跟随标签页',
      'management.tabs.close': '关闭标签页',
      'management.tabs.back': '返回上一页',
      'management.tabs.forward': '前进下一页',
      'management.tabs.reload': '刷新页面',
      'management.tabs.update': '更新标签页',
  ...
  settings: {
    ...
    cdpEnabledHelp: '允许助手通过 Chrome DevTools Protocol 使用受控标签页：观察（深度 DOM 与 shadow/frame 读取、console 与 Log、网络、性能、PDF、截图）以及不受限的调试能力（Runtime.evaluate、Input 点击/输入及相关 CDP 调用）。硬性拒绝列表仍会阻止 Browser.close / crash 与 Target.closeTarget。可能暴露敏感页面与网络数据，附着时会暂停该标签页上你自己的 DevTools。仅在调试时开启，用完请关闭。',
