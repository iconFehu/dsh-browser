...
const EN: PanelCopy = {
  ...
  tool: {
    ...
    labels: {
      ...
      browser_diagnostics: 'Page diagnostics',
      browser_network: 'Network activity',
      browser_performance: 'Performance metrics',
      browser_dom: 'Deep page read',
      browser_screenshot: 'Screenshot',
      browser_export_pdf: 'Export PDF',
    },
...
const ZH: PanelCopy = {
  ...
  tool: {
    ...
    labels: {
      ...
      browser_wait: '等待页面',
      browser_diagnostics: '页面诊断',
      browser_network: '网络活动',
      browser_performance: '性能指标',
      browser_dom: '深层页面读取',
      browser_screenshot: '截图',
      browser_export_pdf: '导出 PDF',
    },
